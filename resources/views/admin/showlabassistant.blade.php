        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <table id="doctorsTable">
              ...
              @foreach($data as $labassistant)
              <tr class="data-row">
                <td>{{ $labassistant->name }}</td>
                <td>{{ $labassistant->email }}</td>
                <td>{{ $labassistant->address }}</td>
                <td>{{ $labassistant->employee_id }}</td>
                <td>{{ $labassistant->shift }}</td>
                <td>{{ $labassistant->job_start_date }}</td>
                <td>{{ $labassistant->experience }}</td>
                <td class="image-cell"><img src="labassistantimage/{{ $labassistant->photo }}" alt="Labassistant Photo"></td>
                <td>
                  <div class="btn-container">
                    <a onclick="return confirm('Are you sure to delete this doctor?')" href="{{ url('deletelabassistant', $labassistant->id) }}" class="btn btn-danger">Delete</a>
                    <a href="{{ url('updatelabassistant', $labassistant->id) }}" class="btn btn-primary">Update</a>
                  </div>
                </td>
              </tr> 
              @endforeach
