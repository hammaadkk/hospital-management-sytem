...
.submit-button:hover {
  ...
  color: white;
       ...
       <form action="{{url('editward',$data->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mt-5 ">
                    <!-- name -->
          ...
          <div class="col-12 col-sm-6 py-2 wow fadeInLeft">
              ...
              <input type="number" class="form-control" placeholder="Enter Total" name="capacity" value="{{$data->capacity}}" id="nameInput" required>
            </div>
