...
<div style="margin-top: 30px;  font-size: 45px; border: 1px solid #00d9a5; background-color: #00d9a5; border-radius: 5px;">Add Lab Assistant</div>
...
.submit-button:hover {
  ...
  color: white;
            ...
            <form action="upload_labassistant" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mt-5 ">
                     <!-- name -->
