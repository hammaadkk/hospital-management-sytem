...
.submit-button:hover {
  ...
  color: white;
       ...
       <form action="{{url('editlabassistant',$data->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mt-5 ">
                    <!-- name -->
          ...
          <img src="labassistantimage/{{$data->photo}}" height="150px" width="150px">
          </div>
          <!-- Photo -->
          <div class="col-12 col-sm-6 py-2 wow fadeInRight">
          ...
          <div class="col-12 py-2 wow fadeInLeft">
            <input type="submit" class="submit-button" value="update labassistant">
          </div>   
