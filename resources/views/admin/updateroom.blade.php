...
.submit-button:hover {
  ...
  color: white;
       ...
       <form action="{{url('editroom',$data->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" class="form-control" placeholder="Enter Room Number" name="room_number" id="room_number" value="{{$data->room_number}}"required>
                </div>
          ...
          <div class="col-12 py-2 wow fadeInLeft">
            <input type="submit" class="submit-button" value="update Room">
          </div>   
