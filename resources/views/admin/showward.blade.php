            ...
            <tr class="data-row">
                ...
                <td>
                  <div class="btn-container">
                    <a onclick="return confirm('Are you sure to delete this ward?')" href="{{ url('deleteward', $ward->id) }}" class="btn btn-danger">Delete</a>
                    <a href="{{ url('updateward', $ward->id) }}" class="btn btn-primary">Update</a>
                  </div>
                </td>
              </tr>
