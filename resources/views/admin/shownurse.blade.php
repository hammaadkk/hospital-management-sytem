        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <tr class="data-row">
                ...
                <td>{{ $nurse->shift }}</td>
                <td>{{ $nurse->job_start_date }}</td>
                <td>{{ $nurse->experience }}</td>
                <td><img src="nurseimage/{{ $nurse->photo }}" alt="Doctor Image"></td>
                <td>
                  <div class="btn-container">
                    <a onclick="return confirm('Are you sure to delete this doctor?')" href="{{ url('deletenurse', $nurse->id) }}" class="btn btn-danger">Delete</a>
                    <a href="{{ url('updatenurse', $nurse->id) }}" class="btn btn-primary">Update</a>
                  </div>
                </td>
              </tr>
