...
<body>
  ...
  <div class="page-section">
    <div class="container">
      <h1 class="text-center wow fadeInUp" style="font-size:40px;" !important>Get in Touch</h1>
      ...
      <form class="contact-form mt-5">
        ...
        <button type="submit" class="btn btn-primary wow zoomIn" style="background-color:#00D9A5;">Send Message</button>
