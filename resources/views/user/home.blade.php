      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" href="#appointmentmake">Make An Appointment</a>
            </li> -->
            <li class="nav-item">
            ...
            @auth
             <li class="nav-item">
            <a class="nav-link" href="#appointmentmake">Make Appointment</a>
          </li>
          <li class="nav-item" style="margin-left: 20px;">
            <a class="nav-link" href="{{url('userdash')}}" style="background-color: greenyellow; color: white;">View Profile</a>
          </li>
            <x-app-layout>  
            </x-app-layout>
            @else
