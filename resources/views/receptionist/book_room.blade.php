        ...
        <div class="container" align="center" style="padding-top :100px;">
            ...
            <div class="page-section">
                <div class="container">
                    ...
                    <form method="POST" action="{{ url('receptionist/upload_room') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mt-5">
                            ...
                            <div class="col-4 col-sm-6 py-2 wow fadeInLeft">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Patient Name" name="name" id="nameInput" required>
                          ...
                          <!-- Room no -->
                            <div class="col-4 col-sm-6 py-2 wow fadeInRight">
                                <div class="form-group">
                                    <label for="bedNoInput">Room No</label>
                                    <select name="room_no" id="bedNoInput" class="form-control" required>
                                        @for($i = 1; $i <= 40; $i++)
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.valid) {
                        ...
                        $('#cnicError').text('Invalid CNIC format');
                    }
                }
            });
        });
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.valid) {
                        ...
                        $('#guardianCnicError').text('Invalid CNIC format');
                    }
                }
            });
        });
